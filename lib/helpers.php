...
function thirdtheme_post_meta() {
    /* tanslators: %s: Post Date */
    printf(
        esc_html__( 'Posted on %s', 'thirdtheme' ),
...
function thirdtheme_readmore_link() {
    echo '<a href="' . esc_url(get_the_permalink()) . '" title="' . the_title_attribute(['echo' => false]) . 
    '">';
    /* tanslators: %s: Post Title */
    printf(
        wp_kses(
            __(' Read More <span class="u-screen-reader-text">About %s</span> ', 'thirdtheme'), 
            [
                'span' => [
                    'class' => []
                ]
